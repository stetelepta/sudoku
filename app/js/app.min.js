...
},{"velocity-animate":4}],6:[function(require,module,exports){
(function () {
    "use strict";
    /*global document*/
...
},{"./animate.js":5,"./samples.js":7,"./sudoku/sudoku.js":11,"./utils.js":12}],7:[function(require,module,exports){
var sudokuSamples = {
    simple: [
        [0, 9, 1, 6, 0, 0, 4, 7, 0],
        [0, 2, 0, 4, 9, 0, 0, 5, 0],
...
module.exports = cell;
},{"./settings.js":10,"smokesignals":1}],9:[function(require,module,exports){
"use strict";
...
var set = {
        ...
        create: function (id, type) {
            ...
            self.lookup = {}; // object for looking up object by cell.
            

            // make set a event emitter
            smokesignals.convert(self);
        ...
        onCellEliminated: function (evt) {
            this.eliminate(evt.target, evt.value);
        },
        ...
        nrPositionsLeft: function (nr) {
            ...
            return {'total': total, 'cell': cell};
        },
        getCellsForNumber: function (nr) {
            return this.p[nr]
        }, 
        eliminate: function(cell, nr) {
            //console.log('set:' + this.type + ' ' + this.id);
            // console.log('for:' + nr + ', cell (' + cell.row + ', ' + cell.col + ') is eliminated');

            // for number, update positions
            this.removePosition(cell, nr);
        },
        removePosition: function(cell, nr) {
            // update possible positions for this, because the target cell is now taken

            delete this.p[nr][cell.id];

            var positionsLeft = this.nrPositionsLeft(nr);
            if (positionsLeft.total === 1) {             
                if (positionsLeft.cell.getValue() === undefined) {
                    console.log('Strategy I: nr ' + nr + ' only fits in ('+ positionsLeft.cell.row + ', ' + positionsLeft.cell.col + ') in '+ this.type + ' ' + this.id);
                    positionsLeft.cell.setValue(nr);                    
                }
            }
         }
    };
...
module.exports = set;
},{"smokesignals":1,"underscore":3}],10:[function(require,module,exports){
"use strict";

var settings = {
    cell: {
        // possible numbers for a certain cell. If there's just one possibility left, it should be the correct number.
        possibilities: [1, 2, 3, 4, 5, 6, 7, 8, 9]
    },
    set: {
        // possible positions for each number in a certain set. Each number holds an array with cell instances.
        possibilities: {
            1: {},
            2: {},
            3: {},
...
},{"./cell.js":8,"./set.js":9,"smokesignals":1}],12:[function(require,module,exports){
"use strict";
